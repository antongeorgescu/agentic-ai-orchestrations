...
def get_agents():
    ...
    welcome_kernel = ChatCompletionAgent(
        ...
        name="WelcomeAgent",
        instructions=(
            "You are a curteous agent who greets the user and introduce the service as a hub for information related to travel information, sport trivia and flights. "
